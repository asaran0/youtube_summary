...
```python
KOKORO_SPEED = 0.95   # 0.80 = slow/authoritative  0.95 = near-natural pace
```
...
```python
EBOOK_CHAPTER_PAUSE     = 1   # silence BEFORE a chapter card starts speaking
EBOOK_LESSON_PAUSE      = 0.5   # silence BEFORE a key lesson
EBOOK_QUOTE_PAUSE_AFTER = 0.3   # silence AFTER a quote finishes
```
